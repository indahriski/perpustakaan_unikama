...
<div style="background: #fff; box-shadow: 4px 4px 2px #bbb; width: 600px; margin: auto; padding: 50px 25px; border-radius: 5px;">
    ...
    <h4 style="margin: 5px; padding: 0; color: #cc4433; text-align: center;">
        <img src="{{ $message->embed(public_path() . '/assets/img/email1.jpg') }}" width="100px">

        <center>  <span
                    style="Margin-top:0;font-weight:normal;font-family:sans-serif;Margin-bottom:15px;text-align:center;font-size:13px;line-height:19px;color:#97a3b1;Margin:0">
                <em><a style="text-decoration: none;font-style:normal;color:#1bb4d5 ;"
                       href=""
                       target="_blank">
                        Perpustakaan Indah</a></em><br>
Jl Aris Joyo Mustoko Tegalsari-kepanjen Malang
                <br>
                Indonesia
              </span>
        </center>
    ...
    <table style="width: 600px;">
        ...
        <tr>
            ...
            <td width="75%" valign="top">{{$id}}</td>
        </tr>
        <tr>
            <td width="25%" valign="top">Nama Petugas</td>
            <td width="75%" valign="top">{{$nama_petugas}}</td>
        </tr>
        <tr>
            <td width="25%" valign="top">Alamat Petugas</td>
            <td width="75%" valign="top">{{$alamat_petugas}}</td>
        </tr>
        <tr>
            <td width="25%" valign="top">Telp Petugas</td>
            <td width="75%" valign="top">{{$tlp_petugas}}</td>
        </tr>
        <tr>
            <td width="25%" valign="top">Images</td>
            <td width="75%" valign="top"> <img src="{{ $message->embed(public_path() . '/assets/foto_petugas/'.$image) }}" width="100px"></td>
        </tr>
        <tr>
    ...
    <p>
        Lakukan Login Website Perpustakaan melalui link:
        <a href="
                {{ URL::to('login') }}">
            <button>Klik</button>
        </a>
        ...
        <td style="padding-top:12px;padding-bottom:14px;padding-right:0;padding-left:0;vertical-align:top;text-align:center">
            <p style="Margin-top:0;font-weight:normal;font-family:sans-serif;Margin-bottom:15px;text-align:center;font-size:13px;line-height:19px;color:#97a3b1;Margin:0">
                <em><a style="text-decoration: none;font-style:normal;color:#1bb4d5 ;"
                       ...
                       target="_blank">Perpustakaan Indah</a></em><br>
                Jl Aris Joyo Mustoko Tegalsari-kepanjen Malang
                <br>
                Indonesia
            </p>
