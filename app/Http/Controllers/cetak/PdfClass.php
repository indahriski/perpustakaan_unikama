...
//            $this->SetMargins(40, 20, 15);
                $this->Cell(150, $this->padding_column, $this->title, 'TBL', 0, 'L');
            $no = $this->PageNo() - 1;
            $pagenumber = '{nb}';
            ...
            if ($this->with_cover == true) {
                ...
                $this->Cell($this->jarak, $this->padding_column, ' - Halaman ' . $this->PageNo() . ' dari '.$pagenumber, 'TBR', 0, 'R');
            }
//            $gambar = 'app/images/officepage-logo.png';
//            if ($this->orientasi == 'P') {
...
//            }
    ...
    function Row4($data, $height = 29, $color = 0) //ukuran kotak
    {
        //Calculate the height of the row
        $nb = 0;
        for ($i = 0; $i < count($data); $i++)
